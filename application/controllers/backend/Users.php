...
class Users extends Backend
{
	...
	public function add()
	{
		...
		else
		{
			...
			if ($this->form_validation->run() === TRUE && $this->ion_auth->register($identity, $password, $email, $additional_data))
			{
				...
				redirect(base_url(Hasher::make(21)));
			}
			else
			{
	...
	public function editar_usuario(){
    	$id_usuario=$this->input->post('id_usuario');
    	$dato['obj']=$this->ion_auth->reset_usuario($id_usuario);
    	$this->load->view('backend/users/editar_usuario',$dato);
    }
	public function guardar_nuevo_usuario(){
    	...
    	$this->ion_auth->guardar_nuevo_usuario($nombre,$apellido,$id_carrera,$id_tipo_usuario,$name,$pass,$idpersona);
	}

	public function guardar_editar_usuario(){
    	
    	$id_tipo_usuario1=$this->input->post('id_tipo_usuario1');
    	...
    	$this->ion_auth->guardar_editar_usuario($id_usuario1,$id_tipo_usuario1);
    }
}
