<div class="page-bar">
	<div class="page-title-breadcrumb">
		<div class=" pull-left">
			<div class="page-title">Administración de Streaming en Vivo</div>
		</div>
		<ol class="breadcrumb page-breadcrumb pull-right">
			...
			<li class="active">Administración de Streaming en Vivo</li>
		</ol>
	</div>
</div>
<div class="row">
	<div class="col-md-12">
		<div class="card card-topline-red">
			<div class="card-head">
				<header>ADMINISTRACION STREAMING</header>
				<div class="tools">
						...
						<div class="btn-group">
							<a href="<?php echo site_url(Hasher::make(69)) ?>">
								<button id="addRow1" class="btn btn-info">
									...
									NUEVA SECCIÓN DE STREAMING <i class="fa fa-plus"></i>
