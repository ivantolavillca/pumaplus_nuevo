        ...
        <div class="row">
            ...
            <div class="col-lg-2">
                <div class="form-group">
                    ...
                    <p><img width="70" height="60" class="visualizar1" src="<?php echo base_url(); ?>assets/archivos_noticias/<?php echo $obj[0]->not_url ?>"></p>
            ...
            <div class="col-md-12">
                <p class="text-center">
                    ...
                    <a href="<?php echo base_url(Hasher::make(270)) ?>" class="btn btn-danger btn-raised">SALIR</a>
                </p>
            </div>
        </div>
    </form>
...
<script>
    ...
    $("#guardar_editado_noticia").submit(function(event) {
        ...
        $.ajax({
            url: '<?php echo base_url(Hasher::make(276)) ?>',
            type: 'POST',
            data: formData,
            cache: false,
            processData: false,
