								...
								<ul class="nav nav-tabs" role="tablist" style="background-color: rgb(156, 39, 176);">
									...
									<li class="nav-item dropdown">
										...
										<div class="dropdown-menu">
											<?php echo anchor(base_url(Hasher::make(27)), '{lang_add_group}', array('class' => 'dropdown-item')); ?>
											<?php //echo anchor('backend/groups/import', '{lang_import_list}', array('class' => 'dropdown-item')); ?>
											<div class="dropdown-divider"></div>
											<?php echo anchor(base_url(Hasher::make(28)), '{lang_export_list}', array('class' => 'dropdown-item')); ?>
										</div>
									</li>
								</ul>
...
<?php foreach ($groups as $group): ?>
												<tr>
													...
													<td>
														<?php echo anchor(base_url(Hasher::make(26, $group->id)), '{lang_edit}', array('class' => 'btn btn-primary btn-sm', 'role' => 'button')); ?>
	<?php
