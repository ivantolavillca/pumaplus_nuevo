...
>
    ...
    <header id="header" >
        <div class="top-bar" style="background: #780206; background: -webkit-linear-gradient(to right, #061161, #780206);background: linear-gradient(to right, #061161, #780206); 
">
            <div class="container" >
                <div class="row">
                    ...
                    <div class="col-sm-5 col-xs-7">
                       <div class="social">
                            <ul class="social-share">
                                ...
                                <li><a href="<?php echo($dat->ins_tiktok)?>"><i class="fa fa-check-square"></i></a></li>
            ...
            <div class="container" >
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="">Reporteros En accion</a></li>  
   ...
   <?php $this->load->view($contenido);?>
    ...
    <footer id="footer" class="midnight-blue">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    &copy; 2023 <a target="_blank" href="" title="S.I.E. - U.P.E.A.">SIE - UPEA</a> Dev. Ivan T.
                </div>
                <div class="col-sm-6">
                    <ul class="pull-right">
