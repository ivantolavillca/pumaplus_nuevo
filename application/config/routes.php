...
*/
$route['default_controller'] = 'Controller_pagina/login';
...
$route['nom'] = 'nombramiento/controlador_nombramiento';
$route['inscrip'] = 'inscripciones/Controlador_inscripciones';

$route['paginaInicio'] = 'Controller_pagina/paginaInicio';

require_once APPPATH . "/libraries/Hasher.php";
$route['pumaplus/([a-zA-Z0-9]+)'] = function ($hash) {
