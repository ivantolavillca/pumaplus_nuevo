...
class MY_Controller extends CI_Controller
{
	...
	public function __construct()
	{
		...
		if ($this->ion_auth->logged_in())
		{
			...
			$this->data['comp'] = $this->data['user_info']['company'];

		}
		
		//nombre de sistema
		$this->data['sistema'] = $this->config->item('UPEA -TELEVIÓN');
...
class Authenticate extends MY_Controller
{
	public function __construct()
	{
		...
		// Title
		$this->data['title'] = ( ! empty($this->config->item('dp_title'))) ? $this->config->item('dp_title') : 'WebSite UPEA Televisión';
	}
